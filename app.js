...
if (typeof SoundManager === 'undefined') {
    class SoundManager {
        ...
        init() {
            const soundFiles = ['click', 'win', 'correct', 'wrong', 'notification'];
...
if (typeof SJGames === 'undefined') {
    class SJGames {
        ...
        showPage(page) {
            ...
            if (page === 'rooms') this.loadActiveRooms();
            if (page === 'profile') this.loadUserProfile();
        }
